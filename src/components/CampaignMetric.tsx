...
export const CampaignMetric = () => {
	const { data: metric, isLoading } = useFetchCampaignMetrics()
		...
		<ul className='md:grid md:grid-cols-2 flex flex-col gap-6 col-span-2'>
			<li className='flex flex-col gap-1 w-full items-center justify-center bg-wustomers-primary rounded-lg py-8 px-6 shadow-[0px_3px_8px_3px_rgba(7,42,200,0.20)]'>
				...
				<p className='text-4xl font-bold'>
					{metric?.total_campaigns.toLocaleString()}
				</p>
			</li>
			<li className='flex flex-col gap-1 w-full items-center justify-center bg-wustomers-primary rounded-lg py-8 px-6 shadow-[0px_3px_8px_3px_rgba(7,42,200,0.20)]'>
				<PlayCircle />
				...
				<p className='text-4xl font-bold'>
					{metric?.live_campaigns.toLocaleString()}
				</p>
			</li>
			<li className='flex flex-col gap-1 w-full items-center justify-center bg-wustomers-primary rounded-lg py-8 px-6 shadow-[0px_3px_8px_3px_rgba(7,42,200,0.20)]'>
				<PauseCircle />
				...
				<p className='text-4xl font-bold'>
					{metric?.inactive_campaigns.toLocaleString()}
				</p>
			</li>
			<li className='flex flex-col gap-1 w-full items-center justify-center bg-wustomers-primary rounded-lg py-8 px-6 shadow-[0px_3px_8px_3px_rgba(7,42,200,0.20)]'>
				<Screen />
				<h4 className='text-base font-medium'>Pending Campaign</h4>
